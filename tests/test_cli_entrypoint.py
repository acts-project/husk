...
MANDATORY as soon as it has two. The container runs `huskd` through Tini with
...
def test_huskd_takes_options_with_no_subcommand():
    # Mirrors the arguments passed to huskd by the container. A nonexistent config makes
